...
// Step-one: populating gallery list with images
...
// Step-two: adding click listening event and handler on the gallery
const galleryClickHandler = event => {
  if (event.target.nodeName !== 'IMG') return;
  event.preventDefault();
  const biggerPicure = basicLightbox.create(
    `<img class="bigger-picture"
